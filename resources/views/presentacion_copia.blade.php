...
<body>
		...
		<div class="container">
			...
			<div class="nav-collapse collapse navbar-responsive-collapse">
				...
				<li data-slide="1" class="col-12 col-sm-2"><a id="menu-link-1" href="#slide-1" title="Next Section"><span class="icon icon-home"></span> <span class="text">HOME</span></a></li>
					...
					<li data-slide="4" class="col-12 col-sm-2"><a id="menu-link-4" href="#slide-4" title="Next Section"><span class="icon icon-sign-in"></span> <span class="text">SIGN IN</span></a></li>
	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			...
			<div id="home-row-2" class="row clearfix">
				<div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="2"><img src="images/s02.png"></div><span>SOBRE NOSOTROS</span></div>
				<div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="4"><img src="images/s03.png"></div><span>SIGN IN</span></div>
				<div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="6"><img src="images/s01.png"></div><span>CONTACTO</span></div>
			</div><!-- /row -->
		</div><!-- /container -->
	</div><!-- /slide1 -->
	...
	<div class="slide story" id="slide-4" data-slide="4">
		<div class="container">
			<div class="row title-row">
				<div class="col-12 font-thin"><span class="font-semibold">Sign in</span></div>
			</div><!-- /row -->
			<div class="row line-row">
				<div class="hr">&nbsp;</div>
			</div><!-- /row -->
			<div class="row subtitle-row">
				<div class="col-sm-1 hidden-sm">&nbsp;</div>
				<div class="col-12 col-sm-10 font-light">Accede a tu área personal de trabajo desde aqui. <br/>Solo estas a un paso</div>
				<div class="col-sm-1 hidden-sm">&nbsp;</div>
			</div><!-- /row -->
	...
	<div class="container">
			<div class="row title-row">
				<div class="col-12 font-thin"><span class="font-semibold">FUNCIONAMIENTO PLATAFORMA</span></div>
			</div><!-- /row -->
			<div class="row line-row">
				<div class="hr">&nbsp;</div>
			</div><!-- /row -->
			<div class="row subtitle-row">
				<div class="col-12 font-thin">Nuestra plataforma es muy sencilla de utilizar ya que se asemeja a la utilización de un ordenador que cualquier de nosotros podamos tener en nuestras casas.<span class="font-semibold"></span></div>
			</div><!-- /row -->
				<div class="row subtitle-row">
				<div class="col-12 font-thin">Podrás logearte desde esta misma página y acceder a tu escritorio personal y tener las aplicaicones necesarias para tu puesto de trabajo <span class="font-semibold"></span></div>
			</div><!-- /row -->
			<!--<div class="row content-row">
	...
	<div class="slide story" id="slide-6" data-slide="6">
		<div class="container">
			<div class="row title-row">
				<div class="col-12 font-light">Contacta con <span class="font-semibold">Hydros</span></div>
			</div><!-- /row -->
			<div class="row line-row">
				<div class="hr">&nbsp;</div>
			</div><!-- /row -->
			<div class="row subtitle-row">
				<div class="col-sm-1 hidden-sm">&nbsp;</div>
				<div class="col-12 col-sm-10 font-light">Dejanos un mensaje y contactaremos contigo lo antes posible</div>
				<div class="col-sm-1 hidden-sm">&nbsp;</div>
			</div><!-- /row -->
			<div id="contact-row-4" class="row">
				...
				<div class="col-12 col-sm-2 with-hover-text">
					...
					<span class="hover-text font-light ">6 26 675 887</span></a>
				</div><!-- /col12 -->
				<div class="col-12 col-sm-2 with-hover-text">
					<p><a target="_blank" href="#"><i class="icon icon-envelope"></i></a></p>
					<span class="hover-text font-light ">support@hydros.com</span></a>
				</div><!-- /col12 -->
				<div class="col-12 col-sm-2 with-hover-text">
					<p><a target="_blank" href="#"><i class="icon icon-home"></i></a></p>
					<span class="hover-text font-light ">Madrid, España<br>cp 28002</span></a>
				</div><!-- /col12 -->
				<div class="col-12 col-sm-2 with-hover-text">
	...
	<script src="js/presentacion/jquery-migrate-1.2.1.min.js"></script>
	<script src="js/presentacion/bootstrap.min.js"></script>
